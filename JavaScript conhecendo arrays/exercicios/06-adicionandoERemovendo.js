...
const clinicaVeterinariaFila = [];

clinicaVeterinariaFila.push("Amora");
clinicaVeterinariaFila.push("Jujuba");
clinicaVeterinariaFila.push("Issac");

console.log(clinicaVeterinariaFila);

clinicaVeterinariaFila.pop();
clinicaVeterinariaFila.pop();
clinicaVeterinariaFila.pop();
